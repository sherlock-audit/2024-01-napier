...
// Credit: https://github.com/0xKitsune/Foundry-Vyper/tree/main
...
contract VyperDeployer {
    ...
    function getEvmVersion() public view returns (string memory) {
        bytes32 _evm_version = bytes32(bytes(abi.encodePacked(evmVersion)));
    ...
    function setEvmVersion(string memory _evm_version) public returns (VyperDeployer) {
    ...
    function deployContract(string memory fileName) public returns (address) {
        ...
        cmds[0] = "vyper";
        cmds[1] = "--evm-version";
        cmds[2] = getEvmVersion();
        cmds[3] = string.concat(fileName, ".vy");
    ...
    function deployContract(string memory fileName, bytes memory args) public returns (address) {
        ...
        bytes memory bytecode = bytes.concat(_bytecode, args);
